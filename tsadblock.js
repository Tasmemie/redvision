! function() {
    function f() {
        ...
        a.id = "levelmaxblock";
        a.innerHTML = '<div class="inner"> <div class="header"> </div> <div class="isi"> <p>المعذرة ! المرجو تعطيل أداة منع الإعلانات.</p><div class="tombol"><a class="2" href="/">تحديث الصفحة</a></div></div></div> ';
